...
\i :TABLE_DIR/color.sql
\i :TABLE_DIR/trim.sql
...
COPY color FROM '/database_setup/databases/car_factory/data/color.csv' WITH (FORMAT CSV, DELIMITER '|', HEADER MATCH);
COPY trim FROM '/database_setup/databases/car_factory/data/trim.csv' WITH (FORMAT CSV, DELIMITER '|', HEADER MATCH);
