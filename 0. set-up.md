...
We note that not all SQL Databases use a network connection.  It's the dominant method for communicating with a SQL database.  We also note that network communication and ports will show up again in future lessons.  
