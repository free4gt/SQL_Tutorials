# Database and SQL Tutorial

This course will emphasize two topics: Structured Query Language (SQL) and Relational Database Management Systems (RDBMS).  SQL is a computer programming language that allows us to interact with databases.  RDBMS almost exclusively uses SQL for most operations.  RDBMS are almost ubiquitous in industry.  They have been associated with SQL since their inception in 1979 (Oracle v2).  For this reason, most RDBMS are called SQL Databases in industry.  We will use this shorthand in this course.  That said RDBMS are not the only systems or databases that use SQL.  SQL has become so popular that it has transcended it's RDBMS origins and can be found in many unexpected places.  All of this will be explained in later lessons.
...
2. Chapter 2 - business viewpoint
3. Chapter 3 - looking under the hood
4. Chapter 4 - SQL create, read, delete and update (CRUD)
5. Chapter 5 - SQL analyzing data
6. ... maybe more